...
def pot_eval(init_score, score, label, q=1e-5, level=0.02):
    ...
    ret = s.run(dynamic=False, with_alarm=False)  # run
    # print(len(ret['alarms']))
    # print(len(ret['thresholds']))
    pot_th = np.mean(ret['thresholds']) * lm[1]
    # pot_th = 0.05 # SMD
    # pot_th = 0.200844426222758195 # SMAP
    # pot_th = 0.02 # NAB
    # pot_th = 0.02162229126 # MSL
    # pot_th = 0.03789801583419759 # MBA
    # pot_th = np.percentile(score, 100 * lm[0])
    # pot_th = 0.1182 # SWaT
    # pot_th = 0.1086 # WADI
    # pot_th = 0.267544052926312965 # UCR
